...
const CustomerReview = () => {
  return (
    <div className="relative">
      ...
      <div className="bg-red-500 h-72 grid-cols-1 rounded-tr-3xl rounded-br-3xl">
      </div>
        <div className="col-span-2 mt-10 ml-32">
            <h1 className="text-2xl font-bold">Sayed Hossain</h1>
            <p className="mt-7 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo incidunt saepe iure natus odio pariatur similique. Sequi, tempore commodi voluptatem impedit dolor voluptates voluptatum cupiditate ad aperiam corporis ea dolorum magni nostrum molestias, similique quis consequatur accusamus veniam architecto et.</p>
            <p className=" mt-10">
      ...
      <div className=" absolute   h-52 w-52 rounded-full top-1/4 left-1/4 overflow-hidden">
